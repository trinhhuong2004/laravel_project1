                ...
                <div class="row">
                    <div class="col-sm-12 col-lg-3 ec-footer-contact">
                        <div class="ec-footer-widget">
                            <div class="ec-footer-logo"><a href="#"><img src="template/assets/images/logo/footer-logo.png"
                                                                         alt=""><img class="dark-footer-logo" src="template/assets/images/logo/dark-logo.png"
                    ...
                    <div class="col footer-bottom-right">
                        <div class="footer-bottom-payment d-flex justify-content-end">
                            <div class="payment-link">
                                <img src="template/assets/images/icons/payment.png" alt="">
                            </div>
